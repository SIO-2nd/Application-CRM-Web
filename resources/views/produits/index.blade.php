...
<a class="btn btn-primary button button3 button_action" href="{{ route('produits.edit', $value->IdProd) }}"><i class="fas fa-pen"></i></a>
@csrf
@method('DELETE')
...
{{ $data->links() }}
<a class="btn btn-primary button button3 button_bottom" href="{{ route('produits.create') }}"><i class="fas fa-plus"></i> Ajouter un nouveau produit</a>
</div>
